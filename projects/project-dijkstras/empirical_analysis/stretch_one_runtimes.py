...
from network_routing import find_shortest_path_with_heap_pq, find_shortest_path_with_linear_pq

from utils import measure_runtime


def main(sizes):
    measure_runtime(sizes, 1, find_shortest_path_with_heap_pq, "_heap_large_pq")
    measure_runtime(sizes, 1, find_shortest_path_with_linear_pq, "_linear_large_pq")
